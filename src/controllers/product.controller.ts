...
export class ProductController {
  ...
  addCategoriesToProduct = async (
    ...
    var result = await productService.addCategoriesToProduct(
      productId,
      value,
      userId
    );
  ...
  addOptionsToProduct = async (req: Request, res: Response): Promise<void> => {
    const { productId } = req.params;
    if (!productId) {
      throw new ValidationError('Product ID is required');
    }
    ...
    var result = await productService.addOptionsToProduct(
      productId,
      value,
      userId
    );
  ...
  addVariantsToProduct = async (req: Request, res: Response): Promise<void> => {
    const { productId } = req.params;
    if (!productId) {
      throw new ValidationError('Product ID is required');
    }
    ...
    var result = await productService.addVariantsToProduct(
      productId,
      value,
      userId
    );
  ...
  addImagesToProduct = async (req: Request, res: Response): Promise<void> => {
    try {
      const { productId } = req.params;
      if (!productId) {
        throw new ValidationError('Product ID is required');
      ...
      var result = await productService.addImagesToProduct(
        productId,
        value,
        userId
      );
  ...
  updateProductStatus = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      var result = await productService.updateProductStatus(
        productId,
        value,
        userId
      );
