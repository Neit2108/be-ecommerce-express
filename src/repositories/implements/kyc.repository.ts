...
export class KycDataRepository implements IKycDataRepository {
  ...
  async findByShopId(shopId: string): Promise<KycData | null> {
    ...
    async updateStatus(id: string, status: KycStatus, reviewerUserId?: string, reviewerNote?: string): Promise<KycData> {
    ...
    async addDocument(kycId: string, documentData: Prisma.KycDocumentCreateInput): Promise<KycDocument> {
    ...
    async updateDocument(documentId: string, status: DocumentStatus, verifierNote?: string): Promise<KycDocument> {
    ...
    async addHistoryEntry(kycId: string, action: string, metadata?: any): Promise<KycHistory> {
