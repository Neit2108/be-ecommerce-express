...
export interface ICartRepository {
  ...
  /**
   * Tìm giỏ hàng theo user ID kèm danh sách items và product variant
   * @param userId - ID của user
   * @param include - Các trường cần lấy thêm
   */
  findByUserIdWithItemsAndVariant(
    userId: string
...
export interface ICartItemRepository {
  ...
  findByIdWithVariant(id: string): Promise<
